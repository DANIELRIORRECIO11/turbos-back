...
public class JwtConfig {
	...
	public final static String CLIENT_CONFIG = "turb0s/tr4ck";
	
	public final static String CLIENT_SECRET = "/Turb0ckTr4cks2o2A/";
	
	public final static String CLIENT_GRANT = "password";
	
	public final static String CLIENT_TYPE = "refresh_token";
	
	public final static String READ = "read";
	
	public final static String WRITE = "write";
	
	public final static int TOKEN_VALIDITY_SECONDS = 3600;
	
	public final static int REFRESH_TOKEN_VALIDITY_SECONDS = 3600;
